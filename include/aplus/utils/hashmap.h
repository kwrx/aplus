 ...
 */
#define __HASHMAP_ITER_RESET(iter) ({ ((iter)->iter_pos = hashmap_base_iter((iter)->iter_map, (iter)->iter_pos)) != NULL; })
...
#define __HASHMAP_FOREACH(x, key, data, h) \
    for (HASHMAP_ITER(*(h)) __HASHMAP_UNIQUE(x, it) = hashmap_iter(h); ((key) = hashmap_iter_get_key(&__HASHMAP_UNIQUE(x, it))) && ((data) = hashmap_iter_get_data(&__HASHMAP_UNIQUE(x, it))); hashmap_iter_next(&__HASHMAP_UNIQUE(x, it)))
#define __HASHMAP_FOREACH_SAFE(x, key, data, h, temp_ptr)                                                                                                                                                            \
    for (HASHMAP_ITER(*(h)) __HASHMAP_UNIQUE(x, it) = hashmap_iter(h); ((temp_ptr) = (void*)((key) = hashmap_iter_get_key(&__HASHMAP_UNIQUE(x, it)))) && ((data) = hashmap_iter_get_data(&__HASHMAP_UNIQUE(x, it))); \
...
#define __HASHMAP_FOREACH_KEY(x, key, h) for (HASHMAP_ITER(*(h)) __HASHMAP_UNIQUE(x, it) = hashmap_iter(h); (key = hashmap_iter_get_key(&__HASHMAP_UNIQUE(x, it))); hashmap_iter_next(&__HASHMAP_UNIQUE(x, it)))
#define __HASHMAP_FOREACH_KEY_SAFE(x, key, h, temp_ptr)                                                                                                \
    for (HASHMAP_ITER(*(h)) __HASHMAP_UNIQUE(x, it) = hashmap_iter(h); ((temp_ptr) = (void*)((key) = hashmap_iter_get_key(&__HASHMAP_UNIQUE(x, it)))); \
         ((temp_ptr) == (void*)hashmap_iter_get_key(&__HASHMAP_UNIQUE(x, it))) ? hashmap_iter_next(&__HASHMAP_UNIQUE(x, it)) : __HASHMAP_ITER_RESET(&__HASHMAP_UNIQUE(x, it)))
#define __HASHMAP_FOREACH_DATA(x, data, h) for (HASHMAP_ITER(*(h)) __HASHMAP_UNIQUE(x, it) = hashmap_iter(h); (data = hashmap_iter_get_data(&__HASHMAP_UNIQUE(x, it))); hashmap_iter_next(&__HASHMAP_UNIQUE(x, it)))
#define __HASHMAP_FOREACH_DATA_SAFE(x, data, h, temp_ptr)                                                                                                                                                  \
    for (HASHMAP_ITER(*(h)) __HASHMAP_UNIQUE(x, it) = hashmap_iter(h); ((temp_ptr) = (void*)hashmap_iter_get_key(&__HASHMAP_UNIQUE(x, it))) && ((data) = hashmap_iter_get_data(&__HASHMAP_UNIQUE(x, it))); \
         ((temp_ptr) == (void*)hashmap_iter_get_key(&__HASHMAP_UNIQUE(x, it))) ? hashmap_iter_next(&__HASHMAP_UNIQUE(x, it)) : __HASHMAP_ITER_RESET(&__HASHMAP_UNIQUE(x, it)))
...
/*
 * Lock the spinlock in the hash map
 *
 * Parameters:
 *    const HASHMAP(<key_type>, <data_type>) *h - hashmap pointer
 */
#define hashmap_lock(h) spinlock_lock(&(h)->map_base.lock)

/*
 * Unlock the spinlock in the hash map
 *
 * Parameters:
 *    const HASHMAP(<key_type>, <data_type>) *h - hashmap pointer
 */
#define hashmap_unlock(h) spinlock_unlock(&(h)->map_base.lock)
