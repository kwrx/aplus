...
x86_get_reg(l, eax) x86_get_reg(l, ebx) x86_get_reg(l, ecx) x86_get_reg(l, edx) x86_get_reg(l, esi) x86_get_reg(l, edi) x86_get_reg(l, ebp) x86_get_reg(l, esp)

    #if defined(__x86_64__)

    x86_get_reg(q, rax) x86_get_reg(q, rbx) x86_get_reg(q, rcx) x86_get_reg(q, rdx) x86_get_reg(q, rsi) x86_get_reg(q, rdi) x86_get_reg(q, rbp) x86_get_reg(q, rsp)

        x86_get_reg(q, cr0) x86_get_reg(q, cr1) x86_get_reg(q, cr2) x86_get_reg(q, cr3) x86_get_reg(q, cr4)

            x86_get_reg(q, cs) x86_get_reg(q, ds) x86_get_reg(q, es) x86_get_reg(q, fs) x86_get_reg(q, gs)

                x86_get_reg(q, r8) x86_get_reg(q, r9) x86_get_reg(q, r10) x86_get_reg(q, r11) x86_get_reg(q, r12)


                    static inline long x86_get_flags() {
    long r;
    __asm__ __volatile__("pushfq; popq %%rax" : "=a"(r));
    return r;
}
...
x86_set_reg(l, eax) x86_set_reg(l, ebx) x86_set_reg(l, ecx) x86_set_reg(l, edx) x86_set_reg(l, esi) x86_set_reg(l, edi) x86_set_reg(l, ebp) x86_set_reg(l, esp)

    #if defined(__x86_64__)

    x86_set_reg(q, rax) x86_set_reg(q, rbx) x86_set_reg(q, rcx) x86_set_reg(q, rdx) x86_set_reg(q, rsi) x86_set_reg(q, rdi) x86_set_reg(q, rbp) x86_set_reg(q, rsp)

        x86_set_reg(q, cr0) x86_set_reg(q, cr1) x86_set_reg(q, cr2) x86_set_reg(q, cr3) x86_set_reg(q, cr4)

            x86_set_reg(q, cs) x86_set_reg(q, ds) x86_set_reg(q, es) x86_set_reg(q, fs) x86_set_reg(q, gs)

                x86_set_reg(q, r8) x86_set_reg(q, r9) x86_set_reg(q, r10) x86_set_reg(q, r11) x86_set_reg(q, r12)


                    static inline void x86_set_flags(long r) {
    __asm__ __volatile__("pushq %%rax; popfq" ::"a"(r));
}
...
outx(b, unsigned char, al) outx(w, unsigned short, ax) outx(l, unsigned int, eax)
    ...
    inx(b, unsigned char, al) inx(w, unsigned short, ax) inx(l, unsigned int, eax)
    ...
    #define outsx(n, t, reg)                                                   \
        ...
        outsx(b, unsigned char, al) outsx(w, unsigned short, ax) outsx(l, unsigned int, eax)
    ...
    #define insx(n, t, reg)                                                 \
        static inline t* ins##n(unsigned short p, t* v, unsigned int len) { \
            ...
            insx(b, unsigned char, al) insx(w, unsigned short, ax) insx(l, unsigned int, eax)
    ...
    __asm__ __volatile__("wrmsr" : : "c"(i), "a"(vl), "d"(vh));
}
...
static inline unsigned long long x86_rdmsr(unsigned long long i) {
    ...
    __asm__ __volatile__("rdmsr" : "=a"(vl), "=d"(vh) : "c"(i));
...
static inline unsigned long long x86_rdtsc(void) {
    ...
    __asm__ __volatile__("lfence; rdtsc; lfence;" : "=a"(vl), "=d"(vh));
...
static inline void x86_cpuid(long r, long* a, long* b, long* c, long* d) {
    __asm__ __volatile__("cpuid" : "=a"(*a), "=b"(*b), "=c"(*c), "=d"(*d) : "a"(r), "c"(0));
}
...
static inline void x86_cpuid_extended(long r, long* a, long* b, long* c, long* d) {
    __asm__ __volatile__("cpuid" : "=a"(*a), "=b"(*b), "=c"(*c), "=d"(*d) : "a"(r), "b"(*b), "c"(*c), "d"(*d));
}
...
static inline unsigned long long x86_rdgsbase() {
    ...
    __asm__ __volatile__("rdgsbase %0" : "=r"(r) : : "memory");
...
static inline unsigned long long x86_rdfsbase() {
    unsigned long long r = 0;
    __asm__ __volatile__("rdfsbase %0" : "=r"(r) : : "memory");
...
static inline void x86_xsetbv(unsigned long long i, unsigned long long v) {
    ...
    __asm__ __volatile__("xsetbv" : : "c"(i), "a"(vl), "d"(vh));
}
...
static inline unsigned long long x86_xgetbv(unsigned long long i) {
    ...
    __asm__ __volatile__("xgetbv" : "=a"(vl), "=d"(vh) : "c"(i));
