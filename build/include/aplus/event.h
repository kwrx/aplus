#ifndef _APLUS_EVENT_H
#define _APLUS_EVENT_H
...
#define sys_event_raise_EV_KEY(id, k, d)        \
    {                                           \
        event_t e;                              \
        e.ev_devid = id;                        \
        e.ev_type = EV_KEY;                     \
...
#define sys_event_raise_EV_REL(id, dx, dy, dz)  \
    {                                           \
        event_t e;                              \
        e.ev_devid = id;                        \
        e.ev_type = EV_REL;                     \
...
#define sys_event_raise_EV_ABS(id, x, y, z)     \
    {                                           \
        event_t e;                              \
        e.ev_devid = id;                        \
        e.ev_type = EV_ABS;                     \
...
#define sys_event_raise_EV_PWR(id, s)           \
    {                                           \
        event_t e;                              \
        e.ev_devid = id;                        \
        e.ev_type = EV_PWR;                     \
