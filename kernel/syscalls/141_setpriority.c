...
/**
 * @brief Sets the niceness of a task, a process group or a user.
 *
 * @param which PRIO_PROCESS, PRIO_PGRP or PRIO_USER.
 * @param who The task, group or user to change, or 0 for the caller's own.
 * @param niceval The niceness to set.
 * @return 0 on success, or a negative errno.
 *
 * @todo A superuser should be able to lower any task's niceness, and is not checked for.
 */
