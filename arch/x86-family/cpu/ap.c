...
__percpu void ap_bmain(uint64_t magic, uint64_t cpu) {
...
void ap_init() {
    ...
    memcpy((void*)arch_vmm_p2v(AP_BOOT_OFFSET, ARCH_VMM_AREA_HEAP), (void*)(&__ap_begin), (size_t)((uintptr_t)(&__ap_end) - (uintptr_t)(&__ap_begin)));
