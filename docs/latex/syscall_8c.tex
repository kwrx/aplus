...
19 
20         \textcolor{keywordflow}{if}(\hyperlink{syscall_8c_afb85e77f03c9acf2f02687360c17dd91}{syscall\_handlers}[sys->\hyperlink{struct____syscall_a7f020a41ed9bf3daff3dfc46ee673eef}{number}])
21             \hyperlink{debug_8c_ac9d768b4772cc87fc88afbbbd805f96a}{kprintf}(\textcolor{stringliteral}{"syscall: duplicate number of %d handler\(\backslash\)n"});
22 
23         \hyperlink{syscall_8c_afb85e77f03c9acf2f02687360c17dd91}{syscall\_handlers}[sys->\hyperlink{struct____syscall_a7f020a41ed9bf3daff3dfc46ee673eef}{number}] = sys->\hyperlink{struct____syscall_af1d75ee98d8568f74e8421654a1081d3}{handler};
24     \}
25 
26     \hyperlink{debug_8c_ac9d768b4772cc87fc88afbbbd805f96a}{kprintf}(\textcolor{stringliteral}{"syscall: loaded %d handlers\(\backslash\)n"}, syslist->\hyperlink{structlist_ae581be90bd8eb7051528b61ad216de88}{size});
27     \hyperlink{list_8h_a9c676c5a77ee9c18ccaadcb4f99fc990}{list\_destroy}(syslist);
28 
29 
30 \textcolor{preprocessor}{#ifdef DEBUG}
31 \textcolor{preprocessor}{    #define NSYSCALLS       1024}
32 
33     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i = 0, s = 0; i < NSYSCALLS; i++) \{
34         \textcolor{keywordflow}{if}(\hyperlink{syscall_8c_afb85e77f03c9acf2f02687360c17dd91}{syscall\_handlers}[i] == NULL) \{
35             \textcolor{keywordflow}{if}(!s)
36                 \textcolor{keywordflow}{continue};
37 
38             \textcolor{keywordflow}{if}(s > 1)
39                 \hyperlink{debug_8c_ac9d768b4772cc87fc88afbbbd805f96a}{kprintf}(\textcolor{stringliteral}{"\(\backslash\)t%d..%d\(\backslash\)n"}, i - s, i - 1);
40             \textcolor{keywordflow}{else}
41                 \hyperlink{debug_8c_ac9d768b4772cc87fc88afbbbd805f96a}{kprintf}(\textcolor{stringliteral}{"\(\backslash\)t%d\(\backslash\)n"}, i - s);
42 
43             s = 0;
...
\begin{DoxyCode}
52                                                                           \{
53     \textcolor{keywordflow}{if}(handler == NULL) \{
54         \hyperlink{errno_8c_ad65a8842cc674e3ddf69355898c0ecbf}{errno} = ENOSYS;
55         \textcolor{keywordflow}{return} -1;
56     \}
57 
58 
59     \textcolor{keywordtype}{int} r = 0;
60 
61     \hyperlink{desc_8c_ad365b1ba0a341f9a84551327fe0dac7b}{\_\_asm\_\_} (
62         \textcolor{stringliteral}{"push ebx           \(\backslash\)n"}
63         \textcolor{stringliteral}{"push ecx           \(\backslash\)n"}
64         \textcolor{stringliteral}{"push edx           \(\backslash\)n"}
65         \textcolor{stringliteral}{"push esi           \(\backslash\)n"}
66         \textcolor{stringliteral}{"push edi           \(\backslash\)n"}
67         \textcolor{stringliteral}{"call eax           \(\backslash\)n"}
68         \textcolor{stringliteral}{"add esp, 20        \(\backslash\)n"}
69         : \textcolor{stringliteral}{"=a"}(r) 
70         : \textcolor{stringliteral}{"a"}(handler), \textcolor{stringliteral}{"b"}(p4), \textcolor{stringliteral}{"c"}(p3), \textcolor{stringliteral}{"d"}(p2), \textcolor{stringliteral}{"S"}(p1), \textcolor{stringliteral}{"D"}(p0)
71     );
72 
73     \textcolor{keywordflow}{return} r;
74 \}
\end{DoxyCode}
