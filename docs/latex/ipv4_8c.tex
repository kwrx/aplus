\hypertarget{ipv4_8c}{\section{Riferimenti per il file src/net/ipv4.c}
...
Referenzia length, uint16\+\_\+t, e uint8\+\_\+t.


\begin{DoxyCode}
13                                            \{
14     \textcolor{keywordtype}{int} \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length} = \textcolor{keyword}{sizeof}(ipv4\_header\_t);
...
Referenzia netif\+::ipv4, ipv4\+\_\+checksum(), I\+P\+V4\+\_\+\+F\+L\+A\+G\+S\+\_\+\+M\+F, I\+P\+V4\+\_\+\+M\+A\+X\+\_\+\+L\+E\+N\+G\+T\+H, I\+P\+V4\+\_\+\+P\+R\+O\+T\+O\+\_\+\+I\+C\+M\+P, I\+P\+V4\+\_\+\+P\+R\+O\+T\+O\+\_\+\+R\+A\+W, I\+P\+V4\+\_\+\+P\+R\+O\+T\+O\+\_\+\+T\+C\+P, I\+P\+V4\+\_\+\+P\+R\+O\+T\+O\+\_\+\+U\+D\+P, kmalloc(), N\+E\+T\+I\+F\+\_\+\+I\+C\+M\+P, N\+E\+T\+I\+F\+\_\+\+T\+C\+P, N\+E\+T\+I\+F\+\_\+\+U\+D\+P, offset, e uint32\+\_\+t.
...
34                                                                                                            
               \{
35 
36     ipv4\_header\_t* ip = (ipv4\_header\_t*) \hyperlink{mm_8h_a1f5d4240b2decc62c0e6eae06c72916c}{kmalloc}(\hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length} + \textcolor{keyword}{sizeof}(ipv4\_header\_t));
37     ip->info = (((\textcolor{keyword}{sizeof}(ipv4\_header\_t) >> 2) & 0xF) << 4) | 4; \textcolor{comment}{/* length: 20 byte; Version: ipv4; */}
38     ip->tos = 0;
39     ip->length = \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length} + \textcolor{keyword}{sizeof}(ipv4\_header\_t);
40     ip->id = 0;
41     ip->ttl = 0xFF;
42 
...
47 
48     \textcolor{keywordflow}{switch}(\hyperlink{eth_8h_acb5cfd209ba75c853d03f701e7f91679}{type}) \{
...
65     memcpy((\textcolor{keywordtype}{void}*) ((\hyperlink{aplus_8h_a53a0df51603c77c2aa5b9ea61b606a82}{uint32\_t}) ip + \textcolor{keyword}{sizeof}(ipv4\_header\_t)), buf, \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length});
66 
...
Referenzia \+\_\+\+\_\+params, I\+P\+V4\+\_\+\+C\+H\+E\+C\+K\+\_\+\+V\+E\+R\+S\+I\+O\+N, I\+P\+V4\+\_\+\+F\+L\+A\+G\+S, I\+P\+V4\+\_\+\+F\+L\+A\+G\+S\+\_\+\+M\+F, I\+P\+V4\+\_\+\+H\+E\+A\+D\+E\+R\+\_\+\+L\+E\+N\+G\+T\+H, I\+P\+V4\+\_\+\+P\+R\+O\+T\+O\+\_\+\+I\+C\+M\+P, I\+P\+V4\+\_\+\+P\+R\+O\+T\+O\+\_\+\+T\+C\+P, I\+P\+V4\+\_\+\+P\+R\+O\+T\+O\+\_\+\+U\+D\+P, kprintf, length, N\+E\+T\+I\+F\+\_\+\+I\+N\+E\+T, netif\+\_\+packets\+\_\+add(), netif\+\_\+packets\+\_\+create(), panic(), e udp\+\_\+recv().
...
88             \textcolor{keywordflow}{return} \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length};
89         
...
93             \textcolor{keywordflow}{return} \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length};
94 
...
98             \textcolor{keywordflow}{return} \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length};
99     \}
100 
...
106                             \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length}, 
107                             \hyperlink{ipv4_8h_ac2a02acc2c7e7b4a4503969db99e9020}{IPV4\_HEADER\_LENGTH}(ip), 
108                             buf
109         )
110     );
111 
112     \hyperlink{aplus_8h_af0b53ac0b8d6868da6396b11b30519c1}{kprintf}(\textcolor{stringliteral}{"ok\(\backslash\)n"});
113     \textcolor{keywordflow}{return} \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length};
114 \}
\end{DoxyCode}
...
Referenzia eth\+\_\+send(), ipv4\+\_\+create\+\_\+packet(), I\+P\+V4\+\_\+\+M\+A\+X\+\_\+\+L\+E\+N\+G\+T\+H, kfree(), length, N\+E\+T\+I\+F\+\_\+\+I\+N\+E\+T, e uint32\+\_\+t.


\begin{DoxyCode}
116                                                                                \{
117     \textcolor{keywordflow}{if}(\hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length} < \hyperlink{ipv4_8h_ae44050a483509e668aad57a5ead0ceb9}{IPV4\_MAX\_LENGTH}) \{
118         \textcolor{keywordtype}{void}* pkt = \hyperlink{ipv4_8c_a695ec6caf08c3272bf42002c51877741}{ipv4\_create\_packet}(netif, buf, \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length}, 
      \hyperlink{eth_8h_acb5cfd209ba75c853d03f701e7f91679}{type}, \hyperlink{eth_8h_a15f677ba1a36e16b06f2b91f545be2f4}{dest}, -1, 0);
119         \textcolor{keywordtype}{int} ret = \hyperlink{eth_8c_ae59b4f0e6c4a9e21facbf96b628f0832}{eth\_send}(netif, pkt, \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length} + \textcolor{keyword}{sizeof}(ipv4\_header\_t), 
...
123             \textcolor{keywordflow}{return} \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length};
124     
...
130     \textcolor{keywordtype}{int} max = \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length} / \hyperlink{ipv4_8h_ae44050a483509e668aad57a5ead0ceb9}{IPV4\_MAX\_LENGTH};
131 
132     \textcolor{keywordflow}{if}(\hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length} % \hyperlink{ipv4_8h_ae44050a483509e668aad57a5ead0ceb9}{IPV4\_MAX\_LENGTH} == 0)
133         max -= 1;
134 
...
136         \textcolor{keywordtype}{void}* pkt = \hyperlink{ipv4_8c_a695ec6caf08c3272bf42002c51877741}{ipv4\_create\_packet}(netif, (\textcolor{keywordtype}{void}*) ((
      ...
      \hyperlink{eth_8h_acb5cfd209ba75c853d03f701e7f91679}{type}, \hyperlink{eth_8h_a15f677ba1a36e16b06f2b91f545be2f4}{dest}, 0, i);
...
142     \textcolor{keywordtype}{void}* pkt = \hyperlink{ipv4_8c_a695ec6caf08c3272bf42002c51877741}{ipv4\_create\_packet}(netif, (\textcolor{keywordtype}{void}*) ((\hyperlink{aplus_8h_a53a0df51603c77c2aa5b9ea61b606a82}{uint32\_t}) buf + (i * 
      \hyperlink{ipv4_8h_ae44050a483509e668aad57a5ead0ceb9}{IPV4\_MAX\_LENGTH})), \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length} - ((i - 1) * IPV4\_MAX\_LENGTH), 
      \hyperlink{eth_8h_acb5cfd209ba75c853d03f701e7f91679}{type}, \hyperlink{eth_8h_a15f677ba1a36e16b06f2b91f545be2f4}{dest}, -1, i);
...
147         \textcolor{keywordflow}{return} \hyperlink{ipv4_8h_a1892eba2086d12ac2b09005aeb09ea3b}{length};
148     
