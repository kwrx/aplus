\hypertarget{eth_8c}{\section{src/net/eth.c File Reference}
...
References \+\_\+\+\_\+params, arp\+\_\+recv(), E\+T\+H\+\_\+\+T\+Y\+P\+E\+\_\+\+A\+R\+P, E\+T\+H\+\_\+\+T\+Y\+P\+E\+\_\+\+I\+P\+V4, E\+T\+H\+\_\+\+T\+Y\+P\+E\+\_\+\+I\+P\+V6, ipv4\+\_\+recv(), ipv6\+\_\+recv(), length, N\+E\+T\+I\+F\+\_\+\+E\+T\+H, netif\+\_\+packets\+\_\+add(), and netif\+\_\+packets\+\_\+create().
...
21             \textcolor{keywordflow}{return} \hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length};
22 
...
26             \textcolor{keywordflow}{return} \hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length};
27 
...
31             \textcolor{keywordflow}{return} \hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length};
32     \}
33 
34 
...
40                             \hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length}, 
41                             \textcolor{keyword}{sizeof}(eth\_header\_t), 
42                             buf
43         )
44     );
45     \textcolor{keywordflow}{return} \hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length};
46 \}
\end{DoxyCode}
...
References eth\+\_\+send\+\_\+packet(), length, netif\+::mtu, type, and uint32\+\_\+t.


\begin{DoxyCode}
79                                                                  \{
80 
81     \textcolor{keywordflow}{if}(\hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length} + \textcolor{keyword}{sizeof}(eth\_header\_t) < netif->\hyperlink{structnetif_a2eb32b1acf0a223c5cc3874da3c2f3df}{mtu}) \{
82         \textcolor{keywordflow}{if}(\hyperlink{eth_8c_aa7c43183772abcca4a7b43ab1ef9faea}{eth\_send\_packet}(netif, buf, \hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length}, \hyperlink{iso9660_8h_a6def72cbab7e986d0ac5dc7291e1394a}{type}) > 0)
83             \textcolor{keywordflow}{return} \hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length};
...
90 
91 
92     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i = 0; i < \hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length}; i += delta)
93         ret += \hyperlink{eth_8c_aa7c43183772abcca4a7b43ab1ef9faea}{eth\_send\_packet}(netif, (\textcolor{keywordtype}{void}*) ((\hyperlink{aplus_8h_a53a0df51603c77c2aa5b9ea61b606a82}{uint32\_t}) buf + i), delta, 
      \hyperlink{iso9660_8h_a6def72cbab7e986d0ac5dc7291e1394a}{type});
94 
...
96         ret += \hyperlink{eth_8c_aa7c43183772abcca4a7b43ab1ef9faea}{eth\_send\_packet}(netif, (\textcolor{keywordtype}{void}*) ((\hyperlink{aplus_8h_a53a0df51603c77c2aa5b9ea61b606a82}{uint32\_t}) buf + length - (length % 
      delta)), length % delta, \hyperlink{iso9660_8h_a6def72cbab7e986d0ac5dc7291e1394a}{type});
97     
98     
99     \textcolor{keywordflow}{if}(ret)
100         \textcolor{keywordflow}{return} \hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length};
101     
...
References E\+T\+H\+\_\+\+T\+Y\+P\+E\+\_\+\+A\+R\+P, E\+T\+H\+\_\+\+T\+Y\+P\+E\+\_\+\+I\+P\+V4, E\+T\+H\+\_\+\+T\+Y\+P\+E\+\_\+\+I\+P\+V6, E\+T\+H\+\_\+\+T\+Y\+P\+E\+\_\+\+R\+A\+W, kfree(), kmalloc(), netif\+::macaddr, N\+E\+T\+I\+F\+\_\+\+A\+R\+P, N\+E\+T\+I\+F\+\_\+\+E\+T\+H, N\+E\+T\+I\+F\+\_\+\+I\+N\+E\+T, N\+E\+T\+I\+F\+\_\+\+I\+N\+E\+T6, netif\+::send, and uint32\+\_\+t.


\begin{DoxyCode}
49                                                                                \{
50     eth\_header\_t* ethpkt = \hyperlink{mm_8h_a1f5d4240b2decc62c0e6eae06c72916c}{kmalloc}(\hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length} + \textcolor{keyword}{sizeof}(eth\_header\_t));
...
53     memcpy((\textcolor{keywordtype}{void}*) ((\hyperlink{aplus_8h_a53a0df51603c77c2aa5b9ea61b606a82}{uint32\_t}) ethpkt + \textcolor{keyword}{sizeof}(eth\_header\_t)), buf, 
      \hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length});
54 
55     \textcolor{keywordflow}{switch}(\hyperlink{iso9660_8h_a6def72cbab7e986d0ac5dc7291e1394a}{type}) \{
...
69 
70     
71     \hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length} += \textcolor{keyword}{sizeof}(eth\_header\_t);
72     
73     \textcolor{keywordtype}{int} ret = netif->\hyperlink{structnetif_ac0505ae55088f68c2cefa77dc6871208}{send}(netif, ethpkt, \hyperlink{iso9660_8h_a190b76b1f3d5bd26920300e5f073739b}{length}, \hyperlink{netif_8h_a1b5ab571fbbee0edabe0bbf9029663cf}{NETIF\_ETH});
