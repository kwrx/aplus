\hypertarget{vfs_8c}{\section{src/fs/vfs.c File Reference}
...
References inode\+::atime, inode\+::chown, inode\+::creat, inode\+::ctime, inode\+::dev, devfs\+\_\+mount(), inode\+::finddir, inode\+::flush, inode\+::gid, G\+I\+D\+\_\+\+R\+O\+O\+T, inode\+::ino, inode\+::ioctl, kmalloc(), inode\+::link, list\+\_\+add(), list\+\_\+init, inode\+::mode, inode\+::mtime, inode\+::name, nextinode, inode\+::nlink, inode\+::parent, inode\+::rdev, inode\+::read, inode\+::readdir, inode\+::rename, inode\+::size, sys\+\_\+time(), inode\+::uid, U\+I\+D\+\_\+\+R\+O\+O\+T, inode\+::unlink, vfs\+\_\+map(), and inode\+::write.
...
97     \hyperlink{vfs_8c_a9af8258c3554800f6613f8147544225f}{vfs\_root}->\hyperlink{structinode_a7e52661a115f6def97778566f2be0d80}{atime} = \hyperlink{vfs_8c_a9af8258c3554800f6613f8147544225f}{vfs\_root}->\hyperlink{structinode_a27334a9d3c25fbac1c134ed5b9cbc566}{ctime} = \hyperlink{vfs_8c_a9af8258c3554800f6613f8147544225f}{vfs\_root}->
      \hyperlink{structinode_a19f0d407fa2962c942e406d3e00c1da4}{mtime} = \hyperlink{time_8c_a4b6eba92722ec1e5446f676e95e4cddf}{sys\_time}(NULL);
...
113 
114 
115     \hyperlink{vfs_8c_acb87c78588a46c5526e933c495b69c2a}{vfs\_map}((\hyperlink{structinode}{inode\_t}*) \hyperlink{devfs_8c_a12b8ede9eeee8603d4b89d189a484380}{devfs\_mount}());
116     
...
References inode\+::ino, list\+\_\+add(), and nextinode.
...
References list\+\_\+foreach, inode\+::name, inode\+::parent, and value.
...
References list\+\_\+foreach, inode\+::parent, and value.
...
References kfree(), and list\+\_\+remove().
