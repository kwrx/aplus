...
32         \hyperlink{errno_8c_ad65a8842cc674e3ddf69355898c0ecbf}{errno} = EBADF;
33         \textcolor{keywordflow}{return} -1;
34     \}
35     
36     st->st\_mode = ino->\hyperlink{structinode_a4902d9f6a1d7bd79c6f1bb73d83ce8e3}{mode};
37     st->st\_ino = ino->\hyperlink{structinode_a1a77be0f24a6c9a18bbdbcecfb75df7c}{ino};
38     st->st\_dev = ino->\hyperlink{structinode_a127a2eb030df332fa64a81188731ad6b}{dev};
39     st->st\_uid = ino->\hyperlink{structinode_a0eac94e96ded19029e871d5cce815bcb}{uid};
40     st->st\_gid = ino->\hyperlink{structinode_a8434fb9dd05057d00b37ed713713835d}{gid};
41     st->st\_atime = ino->\hyperlink{structinode_a7e52661a115f6def97778566f2be0d80}{atime};
42     st->st\_ctime = ino->\hyperlink{structinode_a27334a9d3c25fbac1c134ed5b9cbc566}{ctime};
43     st->st\_mtime = ino->\hyperlink{structinode_a19f0d407fa2962c942e406d3e00c1da4}{mtime};
44     st->st\_nlink = ino->\hyperlink{structinode_a1daedc820c86b5af32f0a137419f7a8f}{nlink};
45     st->st\_size = ino->\hyperlink{structinode_a53722b1b60b7136ce0204b66527bb400}{size};
46     st->st\_rdev = ino->\hyperlink{structinode_a3e7613383954ff7b5faf7c2188e1f61b}{rdev};
47     st->st\_blksize = 512;
48     st->st\_blocks = st->st\_size / st->st\_blksize;
49     
