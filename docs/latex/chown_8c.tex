...
32         \hyperlink{debug_8c_ac9d768b4772cc87fc88afbbbd805f96a}{kprintf}(\textcolor{stringliteral}{"sys\_chown: %s."}, strerror(\hyperlink{errno_8c_ad65a8842cc674e3ddf69355898c0ecbf}{errno}));
33         \textcolor{keywordflow}{return} -1;
34     \}
35     
36     \hyperlink{structinode}{inode\_t}* ino = \hyperlink{chown_8c_a4743b3673a8794b8e7bd0b6c91a63cd5}{current\_task}->\hyperlink{structtask_afeeb6bafaefe505e6a730dd4e0be5a1a}{fd}[fd];
37     \textcolor{keywordflow}{return} \hyperlink{fs_8c_a2928203c42eba392963b57bfed7b65c4}{fs\_chown}(ino, owner, group);
38 \}
\end{DoxyCode}
