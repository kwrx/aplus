...
\begin{DoxyCode}
94                                                              \{
95     \textcolor{keywordflow}{if}(inode->\hyperlink{structinode_a8221183a697c9f2b4e0e295f5a9d8afd}{chown})
96         \textcolor{keywordflow}{return} inode->\hyperlink{structinode_a8221183a697c9f2b4e0e295f5a9d8afd}{chown}(inode, owner, group);
97         
...
\begin{DoxyCode}
70                                                                       \{
71     \textcolor{keywordflow}{if}(inode->\hyperlink{structinode_ad622a049b34780786d9ba4311b06b3b4}{creat})
72         \textcolor{keywordflow}{return} inode->\hyperlink{structinode_ad622a049b34780786d9ba4311b06b3b4}{creat}(inode, \hyperlink{attribute_8h_aae08e5b919f01beb6c69d2859e0dfc27}{name}, mode);
73     
...
51                                                            \{
52 
53     \textcolor{keywordflow}{if}(strcmp(\hyperlink{attribute_8h_aae08e5b919f01beb6c69d2859e0dfc27}{name}, \textcolor{stringliteral}{"."}) == 0)
54         \textcolor{keywordflow}{return} inode;
55 
56     \textcolor{keywordflow}{if}(strcmp(\hyperlink{attribute_8h_aae08e5b919f01beb6c69d2859e0dfc27}{name}, \textcolor{stringliteral}{".."}) == 0)
57         \textcolor{keywordflow}{return} inode->\hyperlink{structinode_a2d4fac4ae14332628e6fa2bd55dd3121}{parent};
58 
59     \hyperlink{structinode}{inode\_t}* map = NULL;
60     \textcolor{keywordflow}{if}((map = (\hyperlink{structinode}{inode\_t}*) \hyperlink{vfs_8c_a99334446cfc1dfc32088d838b4f2895c}{vfs\_mapped}(inode, \hyperlink{attribute_8h_aae08e5b919f01beb6c69d2859e0dfc27}{name})) != NULL)
61         \textcolor{keywordflow}{return} map;
62 
63     \textcolor{keywordflow}{if}(inode->\hyperlink{structinode_ab6c5e2d912fdbd506086e53185cd370d}{finddir})
64         \textcolor{keywordflow}{return} inode->\hyperlink{structinode_ab6c5e2d912fdbd506086e53185cd370d}{finddir}(inode, \hyperlink{attribute_8h_aae08e5b919f01beb6c69d2859e0dfc27}{name});
65         
...
\begin{DoxyCode}
102                                    \{
103     \textcolor{keywordflow}{if}(inode->\hyperlink{structinode_ae2972ef183f5c39aac7cb83b9f8a04a8}{flush})
104         inode->\hyperlink{structinode_ae2972ef183f5c39aac7cb83b9f8a04a8}{flush}(inode);
105         
...
\begin{DoxyCode}
110                                                       \{
111     \textcolor{keywordflow}{if}(inode->\hyperlink{structinode_a636843da203574bc338b016758bf8c7e}{ioctl})
112         \textcolor{keywordflow}{return} inode->\hyperlink{structinode_a636843da203574bc338b016758bf8c7e}{ioctl}(inode, req, buf);
113     
114     \hyperlink{errno_8c_ad65a8842cc674e3ddf69355898c0ecbf}{errno} = ENOSYS;    
...
\begin{DoxyCode}
17                                                       \{
18     \textcolor{keywordflow}{if}(inode->\hyperlink{structinode_ae2c5e8a0a372334b97024fbd9ef694c1}{read})
19         \textcolor{keywordflow}{return} inode->\hyperlink{structinode_ae2c5e8a0a372334b97024fbd9ef694c1}{read}(inode, ptr, len);
20     
21     \hyperlink{errno_8c_ad65a8842cc674e3ddf69355898c0ecbf}{errno} = ENOSYS;        
...
33                                                            \{
34 
35     \hyperlink{structinode}{inode\_t}* map = NULL;
36     \textcolor{keywordflow}{if}((map = (\hyperlink{structinode}{inode\_t}*) \hyperlink{vfs_8c_a4f7b5f17ac7c4b3a0a574d9620e0512d}{vfs\_mapped\_at\_index}(inode, index)) != NULL) \{
37         \textcolor{keyword}{struct }\hyperlink{structdirent}{dirent}* ent = (\textcolor{keyword}{struct }\hyperlink{structdirent}{dirent}*) \hyperlink{mm_8h_a1f5d4240b2decc62c0e6eae06c72916c}{kmalloc}(\textcolor{keyword}{sizeof}(\textcolor{keyword}{struct} 
      \hyperlink{structdirent}{dirent}));
38         strcpy(ent->\hyperlink{structdirent_a39a9af609c1808f0bdf90155bd3f55ed}{d\_name}, map->\hyperlink{structinode_ad64802d9d4ebdd1c56af5ab6e302faf0}{name});
39         ent->\hyperlink{structdirent_aef01e92a29cba347e6e6a5f22d4908a2}{d\_ino} = map->\hyperlink{structinode_a1a77be0f24a6c9a18bbdbcecfb75df7c}{ino};
40         
41         \textcolor{keywordflow}{return} ent;
42     \}
43 
44     \textcolor{keywordflow}{if}(inode->\hyperlink{structinode_a0a54c11571f19f23322f3e6ad3ecb113}{readdir})
45         \textcolor{keywordflow}{return} inode->\hyperlink{structinode_a0a54c11571f19f23322f3e6ad3ecb113}{readdir}(inode, index - \hyperlink{vfs_8c_a829e1c063db610c46554db0e28cb2bcb}{vfs\_mapped\_count}(inode));
46         
47     \hyperlink{errno_8c_ad65a8842cc674e3ddf69355898c0ecbf}{errno} = ENOSYS;    
...
\begin{DoxyCode}
78                                                                   \{
79     \textcolor{keywordflow}{if}(inode->\hyperlink{structinode_a5a309a9c4ada7e4d062162b06125a929}{rename})
80         \textcolor{keywordflow}{return} inode->\hyperlink{structinode_a5a309a9c4ada7e4d062162b06125a929}{rename}(inode, oldname, newname);
81     
...
\begin{DoxyCode}
86                                                 \{
87     \textcolor{keywordflow}{if}(inode->\hyperlink{structinode_adf65bac80736631b8000d3d34e953aaa}{unlink})
88         \textcolor{keywordflow}{return} inode->\hyperlink{structinode_adf65bac80736631b8000d3d34e953aaa}{unlink}(inode, \hyperlink{attribute_8h_aae08e5b919f01beb6c69d2859e0dfc27}{name});
89         
...
\begin{DoxyCode}
25                                                        \{
26     \textcolor{keywordflow}{if}(inode->\hyperlink{structinode_a53a123d38834fa17e7ef5c1e5f47bba2}{write})
27         \textcolor{keywordflow}{return} inode->\hyperlink{structinode_a53a123d38834fa17e7ef5c1e5f47bba2}{write}(inode, ptr, len);
28         
29     \hyperlink{errno_8c_ad65a8842cc674e3ddf69355898c0ecbf}{errno} = ENOSYS;    
