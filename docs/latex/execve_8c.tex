...
References task\+::argv, elf32\+\_\+load(), environ, task\+::envp, errno, task\+::exe, task\+::fd, task\+::image, kfree(), kmalloc(), task\+::length, task\+::ptr, size, sys\+\_\+close(), sys\+\_\+lseek(), sys\+\_\+open(), sys\+\_\+read(), and task\+::vaddr.
...
54 
55     
56     \textcolor{keywordtype}{int} vaddr, vsize;
57     void (*entry) () = (\textcolor{keywordtype}{void} (*) ()) \hyperlink{exec_8c_aeb05ad85647cdfbf15b432a9d2f32926}{elf32\_load}(image, &vaddr, &vsize);
...
63 
64         \hyperlink{execve_8c_a4743b3673a8794b8e7bd0b6c91a63cd5}{current\_task}->\hyperlink{structtask_a3eac6c8a544ff49a836c5eed9ec48107}{image}.\hyperlink{structtask_afbc0623ab058e402e92ea084dc37ab6a}{ptr} = image;
65         \hyperlink{execve_8c_a4743b3673a8794b8e7bd0b6c91a63cd5}{current\_task}->\hyperlink{structtask_a3eac6c8a544ff49a836c5eed9ec48107}{image}.\hyperlink{structtask_a340cbedbdc4b542793e7677dd4966ade}{vaddr} = vaddr;
66         \hyperlink{execve_8c_a4743b3673a8794b8e7bd0b6c91a63cd5}{current\_task}->\hyperlink{structtask_a3eac6c8a544ff49a836c5eed9ec48107}{image}.\hyperlink{structtask_aa90dc3e7e232d6ba3f04700b3197b366}{length} = vsize;
67 
68         \hyperlink{close_8c_a9d94cbe3ac3c59ac54d9e884a024d9c5}{sys\_close}(fd);
69 
70 
71         entry(); \textcolor{comment}{/* never return */}
72     \}
73 
74     \hyperlink{close_8c_a9d94cbe3ac3c59ac54d9e884a024d9c5}{sys\_close}(fd);
75     \hyperlink{mm_8h_acee1960bdb3a19cb495341ec725cafef}{kfree}(image);
