...
24         
25     \textcolor{keywordflow}{if}(!ino->\hyperlink{structinode_a127a2eb030df332fa64a81188731ad6b}{dev})
26         \textcolor{keywordflow}{return} NULL;
27 
28     \textcolor{keywordflow}{if}(!ino->\hyperlink{structinode_a8ba627a7ebbacc723e8452fbf8dd3670}{userdata})
...
75     
76     f->\hyperlink{structinode_a127a2eb030df332fa64a81188731ad6b}{dev} = ino->\hyperlink{structinode_a127a2eb030df332fa64a81188731ad6b}{dev};
...
79     f->\hyperlink{structinode_a0eac94e96ded19029e871d5cce815bcb}{uid} = ino->\hyperlink{structinode_a0eac94e96ded19029e871d5cce815bcb}{uid};
80     f->\hyperlink{structinode_a8434fb9dd05057d00b37ed713713835d}{gid} = ino->\hyperlink{structinode_a8434fb9dd05057d00b37ed713713835d}{gid};
81     f->\hyperlink{structinode_a3e7613383954ff7b5faf7c2188e1f61b}{rdev} = ino->\hyperlink{structinode_a3e7613383954ff7b5faf7c2188e1f61b}{rdev};
...
23         
24     \textcolor{keywordflow}{if}(\hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size} > ino->size)
25         \hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size} = ino->size;
26         
27     \textcolor{keywordflow}{if}(ino->position > ino->size)
28         ino->position = ino->size;
29         
30     \textcolor{keywordflow}{if}(ino->position + \hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size} > ino->size)
31         \hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size} = ino->size - ino->position;
32         
33     \textcolor{keywordflow}{if}(!\hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size})
34         \textcolor{keywordflow}{return} 0;
35 
36     \hyperlink{structinode}{inode\_t}* dev = (\hyperlink{structinode}{inode\_t}*) \hyperlink{devfs_8c_a226c953aff43f9b1e9736908bb6802f3}{devfs\_getdevice}(ino->dev);
37     \textcolor{keywordflow}{if}(!dev)
38         \textcolor{keywordflow}{return} 0;
39 
40     
41     dev->\hyperlink{structinode_a5756f61233e40d01652094d29b5daf6c}{position} = (off\_t) ino->userdata + ino->position;
