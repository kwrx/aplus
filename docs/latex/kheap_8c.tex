...
\begin{DoxyCode}
77                                               \{
78     \textcolor{keywordflow}{if}(!heap)
79         \textcolor{keywordflow}{return} 0;
80         
81     \textcolor{keywordflow}{if}(!heap->\hyperlink{structheap_a5243ef46c552fc0968aa2bcdaf6725d1}{bitmap})
82         \textcolor{keywordflow}{return} 0;
83         
84     \textcolor{keywordflow}{if}(heap->\hyperlink{structheap_a37f3f6d6d39562f3cca452eafebcd7ac}{used} >= heap->\hyperlink{structheap_a486fb531d24b9ee5f17b7ffe96689705}{size})
85         \textcolor{keywordflow}{return} 0;
86 
87     \textcolor{keywordflow}{if}(!\hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size})
88         \textcolor{keywordflow}{return} 0;
89         
90     
91     
92     \hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size} /= \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE};
93     \hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size} += 1;
94     
95 
96     \textcolor{keywordtype}{int} index = \hyperlink{kheap_8c_a74ba44118238191dbc2c0aa8cb715b2a}{bitmap\_first}(heap, \hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size});
97     \textcolor{keywordflow}{if}(index == -1)
98         \textcolor{keywordflow}{return} 0;
99                 
100     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i = 0; i < \hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size}; i++)
101         \hyperlink{kheap_8c_a74db82a3840a04b119ef68ace44be19a}{BITMAP\_SET}(heap->\hyperlink{structheap_a5243ef46c552fc0968aa2bcdaf6725d1}{bitmap}, (index + i));
102     
103     
104     heap->\hyperlink{structheap_a37f3f6d6d39562f3cca452eafebcd7ac}{used} += (size * \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE});
105     
106     \textcolor{keywordflow}{return} (\textcolor{keywordtype}{void}*) (index * \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE});
107 \}
\end{DoxyCode}
...
References heap\+::bitmap, B\+I\+T\+M\+A\+P\+\_\+\+T\+S\+T, B\+L\+K\+S\+I\+Z\+E, heap\+::size, and size.


\begin{DoxyCode}
54                                                    \{
55     \textcolor{keywordflow}{if}(\hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size} == 0)
56         \textcolor{keywordflow}{return} -1;
57         
58 
59     \textcolor{keywordtype}{int} hsize = heap->\hyperlink{structheap_a486fb531d24b9ee5f17b7ffe96689705}{size} / \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE};
60 
61     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i = 0; i < hsize; i++) \{    
62         \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} j = 0, f = 0; j < \hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size}; j++) \{
63             \textcolor{keywordflow}{if}(\hyperlink{kheap_8c_a47df99630658921f6898646851230983}{BITMAP\_TST}(heap->\hyperlink{structheap_a5243ef46c552fc0968aa2bcdaf6725d1}{bitmap}, (i + j)))
64                 \textcolor{keywordflow}{continue};
65             
66             f++;    
67             \textcolor{keywordflow}{if}(f == size)
...
\begin{DoxyCode}
109                                                         \{
110     \textcolor{keywordflow}{if}(!heap)
111         \textcolor{keywordflow}{return};
112         
113     \textcolor{keywordflow}{if}(!heap->\hyperlink{structheap_a5243ef46c552fc0968aa2bcdaf6725d1}{bitmap})
114         \textcolor{keywordflow}{return};
115         
116 
117     \textcolor{keywordflow}{if}(\hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size} % \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE}) \{
...
119         \hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size} += 1;
120     \}\textcolor{keywordflow}{else} \{
121         \hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size} /= \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE};
122     \}
123     
124     \textcolor{keywordtype}{int} index = \hyperlink{kheap_8c_a112c287ac25c656c889838c3629d822b}{GETBIT}(addr);
125     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i = 0; i < \hyperlink{iso9660_8h_ae5dc6ffcd9b7605c7787791e40cc6bb0}{size}; i++)
126         \hyperlink{kheap_8c_a117b3288a72c30a6c9be0e2773332705}{BITMAP\_CLR}(heap->\hyperlink{structheap_a5243ef46c552fc0968aa2bcdaf6725d1}{bitmap}, (index + i));
127         
128         
129     heap->\hyperlink{structheap_a37f3f6d6d39562f3cca452eafebcd7ac}{used} -= (size * \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE});
130 \}
\end{DoxyCode}
...
134                  \{
135 
136     \hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}.\hyperlink{structheap_a5243ef46c552fc0968aa2bcdaf6725d1}{bitmap} = (\hyperlink{aplus_8h_a53a0df51603c77c2aa5b9ea61b606a82}{uint32\_t}*) \hyperlink{kheap_8c_ab27b0e2ca68753b0298fd591615a6592}{\_\_bitmap};
137     \hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}.\hyperlink{structheap_a486fb531d24b9ee5f17b7ffe96689705}{size} = \hyperlink{kheap_8c_a8ffb348d372acd38099f16b08bdaf4b5}{memsize};
138     \hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}.\hyperlink{structheap_a8b4bc8c3f0ed79efd52d61a27a62a130}{alloc} = \hyperlink{kheap_8c_a5091f353b0ceafc7134382b4386d206c}{bitmap\_alloc};
139     \hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}.\hyperlink{structheap_ae53b14c50bbb9daab4346cd0873bda02}{free} = \hyperlink{kheap_8c_ae9ee37909a7c84b79ce0d7d0414ebeee}{bitmap\_free};
140     
141     memset(\hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}.\hyperlink{structheap_a5243ef46c552fc0968aa2bcdaf6725d1}{bitmap}, 0, (\hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}.\hyperlink{structheap_a486fb531d24b9ee5f17b7ffe96689705}{size} / \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE}));
142     
143     \hyperlink{mm_8c_a6f69e1474f69d9286294cfa23cdcc414}{mm\_setheap}(&\hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap});
144     
145     \textcolor{comment}{// Alloc first 4MB (reserved physical kernel area)}
146     \hyperlink{heap_8c_ace4a8a1fe937911a1a107c92e6d40339}{halloc}(&\hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}, (\textcolor{keywordtype}{size\_t}) 0x400000);
147     
148 
