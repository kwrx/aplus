\hypertarget{kheap_8c}{\section{Riferimenti per il file src/mm/kheap.c}
...
Referenzia heap\+::bitmap, bitmap\+\_\+first(), B\+I\+T\+M\+A\+P\+\_\+\+S\+E\+T, B\+L\+K\+S\+I\+Z\+E, size, heap\+::size, e heap\+::used.
...
84         
85     
86     \textcolor{keywordflow}{if}(\hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size} % \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE}) \{
87         \hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size} /= \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE};
88         \hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size} += 1;
89     \}\textcolor{keywordflow}{else} \{
90         \hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size} /= \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE};
91     \}   
92         
93     \textcolor{keywordtype}{int} index = \hyperlink{kheap_8c_a74ba44118238191dbc2c0aa8cb715b2a}{bitmap\_first}(heap, \hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size});
94     \textcolor{keywordflow}{if}(index == -1)
95         \textcolor{keywordflow}{return} 0;
96                 
97     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i = 0; i < \hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size}; i++)
...
99     
100     
101     heap->\hyperlink{structheap_a37f3f6d6d39562f3cca452eafebcd7ac}{used} += \hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size};
102     
...
Referenzia heap\+::bitmap, B\+I\+T\+M\+A\+P\+\_\+\+T\+S\+T, size, e heap\+::size.


\begin{DoxyCode}
55                                                    \{
56     \textcolor{keywordflow}{if}(\hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size} == 0)
...
60         \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} j = 0, f = 0; j < \hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size}; j++) \{
...
Referenzia heap\+::bitmap, B\+I\+T\+M\+A\+P\+\_\+\+C\+L\+R, B\+L\+K\+S\+I\+Z\+E, G\+E\+T\+B\+I\+T, size, e heap\+::used.
...
112         
113         
114     \textcolor{keywordflow}{if}(\hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size} % \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE}) \{
115         \hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size} /= \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE};
116         \hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size} += 1;
117     \}\textcolor{keywordflow}{else} \{
118         \hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size} /= \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE};
119     \}   
120         
121     
122     \textcolor{keywordtype}{int} index = \hyperlink{kheap_8c_a112c287ac25c656c889838c3629d822b}{GETBIT}(addr);
123     \textcolor{keywordflow}{for}(\textcolor{keywordtype}{int} i = 0; i < \hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size}; i++)
...
125         
126         
127     heap->\hyperlink{structheap_a37f3f6d6d39562f3cca452eafebcd7ac}{used} -= \hyperlink{mm_8c_a854352f53b148adc24983a58a1866d66}{size};
128 \}
\end{DoxyCode}
...
Referenzia \+\_\+\+\_\+bitmap, heap\+::alloc, heap\+::bitmap, bitmap\+\_\+alloc(), bitmap\+\_\+free(), B\+L\+K\+S\+I\+Z\+E, heap\+::free, halloc(), memsize, mm\+\_\+setheap(), heap\+::size, e uint32\+\_\+t.


\begin{DoxyCode}
132                  \{
133     \textcolor{keyword}{extern} \hyperlink{aplus_8h_a53a0df51603c77c2aa5b9ea61b606a82}{uint32\_t} end;
134 
135     \hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}.\hyperlink{structheap_a5243ef46c552fc0968aa2bcdaf6725d1}{bitmap} = \hyperlink{kheap_8c_ab27b0e2ca68753b0298fd591615a6592}{\_\_bitmap};
136     \hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}.\hyperlink{structheap_a486fb531d24b9ee5f17b7ffe96689705}{size} = \hyperlink{kheap_8c_a8ffb348d372acd38099f16b08bdaf4b5}{memsize} / \hyperlink{mm_8h_ac4551bbc9efabf8378f35498f80b4679}{BLKSIZE};
137     \hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}.\hyperlink{structheap_a8b4bc8c3f0ed79efd52d61a27a62a130}{alloc} = \hyperlink{kheap_8c_a5091f353b0ceafc7134382b4386d206c}{bitmap\_alloc};
138     \hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}.\hyperlink{structheap_ae53b14c50bbb9daab4346cd0873bda02}{free} = \hyperlink{kheap_8c_ae9ee37909a7c84b79ce0d7d0414ebeee}{bitmap\_free};
139     
140     memset(\hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}.\hyperlink{structheap_a5243ef46c552fc0968aa2bcdaf6725d1}{bitmap}, 0, \hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}.\hyperlink{structheap_a486fb531d24b9ee5f17b7ffe96689705}{size});
141     
142     \hyperlink{mm_8c_a6f69e1474f69d9286294cfa23cdcc414}{mm\_setheap}(&\hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap});
143     
144     \textcolor{comment}{// Alloc first 4MB (reserved physical kernel area)}
145     \hyperlink{heap_8c_ace4a8a1fe937911a1a107c92e6d40339}{halloc}(&\hyperlink{kheap_8c_ab18276b758b671778bcef772dee38c85}{kheap}, (\textcolor{keywordtype}{size\_t}) 0x400000);
146     
147 
